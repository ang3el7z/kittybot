...
- `BackupRestoreService` owns simple, medium, and WireGuard backup restore sections: certs, dnstt, hwid normalization, service states, pac, shadowsocks, adguard, mtproto, ocserv, hysteria, wg, wg1.
